...
* Your adversary could use Celebrite's UFED or other technical means to hack your phone and is ready to do forensic research. Such an adversary could be a customs officer at the border or a member of the security services. Unfortunately, data destruction may leave [countless traces]((https://discuss.grapheneos.org/d/40668-duress-persecuted-as-destruction-of-evidence-in-us/78)) of deleted data.and it is impossible to conceal all of them. Forensic experts may be unable to recover the deleted data itself, but they may still be able to determine that data was deliberately destroyed. If that poses a serious risk to you, you should not use Android AntiForensic Tools. In this case, you should use [Graphene OS](https://grapheneos.org/) if it's possible. 
