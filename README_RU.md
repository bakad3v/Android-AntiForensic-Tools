...
Если Вы не можете выдать приложению root-права, то вы можете предоставить приложению права владельца устройства через [Dhizuku](https://github.com/iamr0s/Dhizuku).
### Триггеры
