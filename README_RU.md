...
* Ваш противник может использовать Cellebrite UFED или другие технические средства для того, чтобы взломать ваш телефон. Таким противником может быть таможенник на границе или работник спецслужб. В таком случае вам нужно использовать [Graphene OS](https://grapheneos.org/), если это возможно. Использование Android AntiForensic Tools c Graphene OS - это очень спорная идея. Android AntiForensic Tools может позволить вам очень быстро удалить ваши данные, нажав кнопку питания несколько раз подряд, но неизвестно, можно ли будет выяснить, что ваша информация была удалена, при детальном осмотре девайса. Более того, использовании root прав или других привелегий может сломать модель безопасности Graphene OS. Возможно вам лучше использовать встроенную опцию самоуничтожения в Graphene OS, но такое самоуничтожение будет очевидно для противника и может его разозлить.
