...
* Clear & hide. Приложение очистит свои данные и скроет себя. Менее надёжная альтернатива самоуничтожению для использования с правами  dhizuku. Работает нестабильно. Замечено, что чаще срабатывает до первой разблокировки устройства, чем после неё. Требует Android 9 и выше.
