...
* Ваш противник может использовать Cellebrite UFED или другие технические средства для того, чтобы взломать ваш телефон и готов его тщательно анализировать. Таким противником может быть таможенник на границе или работник спецслужб. К сожалению, после удаления ваших данных в системе [останется](https://discuss.grapheneos.org/d/40668-duress-persecuted-as-destruction-of-evidence-in-us/78) бесчисленное множество следов, которые продвинутый противник сможет обнаружить. Он скорее всего не сможет восстановить удалённые данные, но сможет выяснить, что вы их удаляли, и если для вас это серьёзная угроза - не используйте Android AntiForensic Tools. Для защиты от такого рода угроз вам нужно использовать [Graphene OS](https://grapheneos.org/), если это возможно.
