...
import net.typeblog.shelter.domain.usecases.bruteforce.GetBruteforceSettingsUseCase
import net.typeblog.shelter.domain.usecases.bruteforce.SetBruteForceLimitUseCase
import net.typeblog.shelter.domain.usecases.bruteforce.SetBruteForceStatusUseCase
import net.typeblog.shelter.domain.usecases.button.GetButtonSettingsUseCase
import net.typeblog.shelter.domain.usecases.button.SetClicksNumberUseCase
import net.typeblog.shelter.domain.usecases.button.SetLatencyUseCase
import net.typeblog.shelter.domain.usecases.button.SetTriggerOnButtonUseCase
import net.typeblog.shelter.domain.usecases.passwordManager.SetPasswordUseCase
import net.typeblog.shelter.domain.usecases.permissions.GetPermissionsUseCase
import net.typeblog.shelter.domain.usecases.permissions.SetOwnerActiveUseCase
import net.typeblog.shelter.domain.usecases.permissions.SetRootActiveUseCase
import net.typeblog.shelter.domain.usecases.settings.GetMultiuserUIUseCase
import net.typeblog.shelter.domain.usecases.settings.GetSafeBootRestrictionUseCase
import net.typeblog.shelter.domain.usecases.settings.SetMultiuserUIUseCase
import net.typeblog.shelter.domain.usecases.settings.GetSettingsUseCase
import net.typeblog.shelter.domain.usecases.settings.GetUserLimitUseCase
import net.typeblog.shelter.domain.usecases.settings.GetUserSwitchRestrictionUseCase
import net.typeblog.shelter.domain.usecases.settings.GetUserSwitcherStatusUseCase
import net.typeblog.shelter.domain.usecases.settings.SetCleaItselfUseCase
import net.typeblog.shelter.domain.usecases.settings.SetClearDataUseCase
import net.typeblog.shelter.domain.usecases.settings.SetHideUseCase
import net.typeblog.shelter.domain.usecases.settings.SetLogdOnBootUseCase
import net.typeblog.shelter.domain.usecases.settings.SetLogdOnStartUseCase
import net.typeblog.shelter.domain.usecases.settings.SetRemoveItselfUseCase
import net.typeblog.shelter.domain.usecases.settings.SetRunOnDuressUseCase
import net.typeblog.shelter.domain.usecases.settings.SetSafeBootRestrictionUseCase
import net.typeblog.shelter.domain.usecases.settings.SetThemeUseCase
import net.typeblog.shelter.domain.usecases.settings.SetTrimUseCase
import net.typeblog.shelter.domain.usecases.settings.SetUserLimitUseCase
import net.typeblog.shelter.domain.usecases.settings.SetUserSwitchRestrictionUseCase
import net.typeblog.shelter.domain.usecases.settings.SetUserSwitcherUseCase
import net.typeblog.shelter.domain.usecases.settings.SetWipeUseCase
import net.typeblog.shelter.domain.usecases.usb.GetUsbSettingsUseCase
import net.typeblog.shelter.domain.usecases.usb.SetUsbSettingsUseCase
