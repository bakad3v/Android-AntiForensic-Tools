package net.typeblog.shelter.superuser.root
...
import net.typeblog.shelter.data.mappers.ProfilesMapper
...
import net.typeblog.shelter.presentation.receivers.DeviceAdminReceiver
    ...
    override suspend fun getSafeBootStatus(): Boolean {
        ...
        try {
            ...
            throw SuperUserException(
                ...
                UIText.StringResource(R.string.number_not_found)
            )
        }
    }
