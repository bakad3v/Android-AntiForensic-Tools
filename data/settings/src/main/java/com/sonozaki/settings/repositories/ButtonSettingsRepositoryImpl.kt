...
class ButtonSettingsRepositoryImpl @Inject constructor(@ApplicationContext private val context: Context, buttonSettingsSerializer: com.sonozaki.encrypteddatastore.encryption.EncryptedSerializer<ButtonSettings>) : ButtonSettingsRepository {
