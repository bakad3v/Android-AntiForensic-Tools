...
class DeviceAdmin @Inject constructor(@ApplicationContext private val context: Context, private val dpm: DevicePolicyManager, private val setAdminInactiveUseCase: SetAdminInactiveUseCase):
    SuperUser {
